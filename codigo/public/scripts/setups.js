...
document
  .getElementById('setup-low')
  .addEventListener('click', () => renderComponents(carregaVideo1()))
document
  .getElementById('setup-medio')
  .addEventListener('click', () => renderComponents(carregaVideo2()))
document
  .getElementById('setup-high')
  .addEventListener('click', () => renderComponents(carregaVideo3()))
document
  .getElementById('setup-ultra')
  .addEventListener('click', () => renderComponents(carregaVideo4()))
