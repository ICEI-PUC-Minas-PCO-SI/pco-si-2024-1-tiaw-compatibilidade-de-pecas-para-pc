...
function abremodalGPU() {
    ...
    <p class = "text-justify">Uma GPU, ou unidade de processamento gráfico, é um componente crucial em desktops para jogos, responsável por renderizar imagens, vídeos e animações. Ela desempenha um papel vital ao garantir que os jogos rodem com gráficos de alta qualidade e com taxas de quadros suaves.<br><br>
...
function abremodalPlacaMae() {
    ...
    <p class = "text-justify">A placa-mãe é um componente fundamental em desktops para jogos, funcionando como a espinha dorsal do computador. Ela conecta e permite a comunicação entre todos os outros componentes, como a CPU, GPU, memória RAM, discos rígidos, SSDs e dispositivos periféricos.<br><br>
